...
import Component from '../components/AI/Component.vue'
import DevicePreview from '../components/AI/DevicePreview.vue'
import DeviceManagement from '../components/AI/DeviceManagement.vue'
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: 'channelList/:deviceId/:parentChannelId/',
              name: 'channelList',
              component: () => import('@/components/AI/ChannelList'),
            },
            {
              path: 'streamProxyList',
