...
<script>
	import streamProxyEdit from '@/components/dialog/StreamProxyEdit.vue'
	import onvifEdit from '@/components/dialog/onvifEdit.vue'
	import devicePlayer from '@/components/dialog/devicePlayer.vue'
